...
# python C:\Users\Administrator\Desktop\OptionFlow\broadcast_remote.py -url https://app.flowalgo.com/ -login_url https://app.flowalgo.com/users/login -proxy http:3.92.226.234:80 -username optionflow5 -password option123 -free_target "Option Flow Free" -vip_target "Option Flow VIP"
